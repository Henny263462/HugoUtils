...
object GuiCaptureHooks {
    @JvmStatic
    fun render(screen: Screen, context: DrawContext, mouseX: Int, mouseY: Int) {
        GuiCaptureController.activeFor(screen)?.render(context, mouseX, mouseY)
    }

    @JvmStatic
    fun mouseClicked(screen: Screen, click: Click): Boolean {
    ...
    @JvmStatic
    fun blocksSlotClicks(screen: Screen): Boolean =
        GuiCaptureController.activeFor(screen) != null

    @JvmStatic
    fun keyPressed(screen: Screen, input: KeyInput): Boolean {
    ...
    @JvmStatic
    fun charTyped(screen: Screen, input: CharInput): Boolean =
